...
function recordBatchReaders(createSourceStream) {
    return tslib_1.__asyncGenerator(this, arguments, function* recordBatchReaders_1() {
        ...
        try {
            try {
                for (var _c = tslib_1.__asyncValues(Arrow_node_1.RecordBatchReader.readAll(stream)), _d; _d = yield tslib_1.__await(_c.next()), !_d.done;) {
                    reader = _d.value;
        ...
        if (!readers) {
            ...
            try {
                try {
                    for (var _e = tslib_1.__asyncValues(Arrow_node_1.RecordBatchReader.readAll(bignumJSONParse(yield tslib_1.__await(json.toString())))), _f; _f = yield tslib_1.__await(_e.next()), !_f.done;) {
                        reader = _f.value;
                        reader && (yield yield tslib_1.__await(reader));
                    }
                }
